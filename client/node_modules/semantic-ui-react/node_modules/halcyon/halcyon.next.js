...
export { add, all, always, any, append, assoc, chain, clamp, concat, cond, contains, compact, complement, compose, curry, curryN, dec, dissoc, divide, drop, dropUntil, dropWhile, empty, equals, F, filter, find, findIndex, findLast, chain as flatMap, flatten, flattenDeep, flip, fmap, forEach, fromPairs, groupBy, gt, gte, has, head, identical, identity, ifElse, inc, init, insert, isEmpty, isEven, isNil, isOdd, isType, intersection, join, juxt, keys, last, length, lens, lensProp, lt, lte, map, mapi, mapKeys, match, max, mean, merge, min, multiply, of, omit, over, pad, padLeft, padRight, pair, partition, path, pick, pipe, prepend, prop, propEq, range, rangeBy, reduce, reduce as foldl, reduceRight, reduceRight as foldr, reject, replace, reverse, scan, set, split, subtract, sum, T, tail, take, takeUntil, takeWhile, tap, test, times, toLower, toUpper, toPairs, trace, transform, trim, typeOf as type, unique, unless, values, view, when, where, without, zip, zipObj };